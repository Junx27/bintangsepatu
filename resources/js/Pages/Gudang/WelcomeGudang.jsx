...
function WelcomeGudang() {
    return (
        <Guest title={"Welcome Tim Gudang"}>
            <div>
                ...
                <p className="mt-3 text-center border-b border-dashed pb-5 mx-20">
                    Selamat Datang, di menu Tim Gudang silahkan melakukan login
                    atau sign up (jika belum memiliki akun), lalu tunggu
                ...
                <div className="flex justify-center gap-10 mt-10">
                    <div className="transition-all duration-500 w-72 shadow-lg rounded-xl p-5 hover:shadow-xl hover:bg-yellow-500">
                        ...
                        <div className="flex justify-center hover:bg-blue-50 p-2 rounded-lg">
                            <a href="/login-gudang">Selengkapnya &rarr;</a>
                        </div>
                    </div>
                    <div className="transition-all duration-500 w-72 shadow-lg rounded-xl p-5 hover:shadow-xl hover:bg-yellow-500">
                        <img
                        ...
                        <div className="flex justify-center hover:bg-blue-50 p-2 rounded-lg">
                            <a href="/register-gudang">Selengkapnya &rarr;</a>
                        </div>
                    </div>
                </div>
            </div>
